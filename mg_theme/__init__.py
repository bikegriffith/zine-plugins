...
blue_variation = u'mg_theme::blue.css'
variations = {
    blue_variation:             _('Blue'),
    u'mg_theme::gray.css':  _('Gray'),
    u'mg_theme::green.css': _('Green')
}
...
def configure(request):
    ...
    form = ConfigurationForm(initial=dict(
        variation=cfg['mg_theme/variation']
    ))
    ...
    if request.method == 'POST':
        if 'cancel' in request.form:
            ...
            cfg.change_single('mg_theme/variation', form['variation'])
            return form.redirect('admin/theme')

    return render_admin_response('admin/configure_mg_theme.html',
...
def setup(app, plugin):
    ...
    app.add_shared_exports('mg_theme', SHARED_FILES)
    app.add_config_var('mg_theme/variation',
